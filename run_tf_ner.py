...
def main():
    ...
    if training_args.do_eval:
        ...
        predictions, label_ids, metrics = trainer.predict(eval_dataset.get_dataset())
        preds_list, labels_list = align_predictions(predictions, label_ids)
        report = classification_report(labels_list, preds_list)

        logger.info("***Classification report for dev split***\n%s", report)
...
#            results.update(result)
    ...
    if training_args.do_predict:
        ...
        logger.info("***Classification report for test split***\n%s", report)
